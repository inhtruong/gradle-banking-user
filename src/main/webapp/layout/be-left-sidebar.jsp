            ...
            <div class="left-sidebar-scroll">
                <div class="left-sidebar-content">
                    <ul class="sidebar-elements">
                        ...
                        <li class="active"><a href="/user"><i class="icon mdi mdi-home"></i><span>Quản lý người dùng</span></a>
                        </li>
                        <li class="active"><a href="/user?action=history"><i class="icon mdi mdi-face"></i><span>Lịch sử giao dịch</span></a>
<%--                            <ul class="sub-menu">--%>
